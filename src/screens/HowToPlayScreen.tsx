...
const PLAY_STEPS = [
    {
        ...
        description: 'اختر فئة الكلمات التي ستلعبون بها ثم أضف أسماء اللاعبين (3 على الأقل)، وحدد عدد "الضائعين".',
    },
    {
        id: '2',
        icon: <EyeOff size={24} color="#4ecca3" />,
        title: '2. كشف الأدوار بسريّة',
        description: 'مرر الجوال بين اللاعبين. سيظهر لكل لاعب إما "الكلمة السرية" (مثلاً: أسد) أو دور "الضائع" الذي لا يعرف الكلمة.',
    },
    {
        id: '3',
        icon: <Lightbulb size={24} color="#ff7315" />,
        title: '3. وقت التلميحات',
        description: 'بالترتيب، يقول كل لاعب "كلمة واحدة فقط" تلمّح للكلمة السرية. الهدف إثبات أنك تعرفها دون أن تفضحها للضائع!',
    },
    {
        id: '4',
        icon: <Vote size={24} color="#4ecca3" />,
        title: '4. النقاش والتصويت',
        description: 'بعد انتهاء التلميحات، تناقشوا ثم يصوت كل لاعب سراً للشخص الذي يشك بأنه "الضائع".',
    },
    {
        id: '5',
        icon: <Target size={24} color="#ff7315" />,
        title: '5. فرصة الضائع',
        description: ' تُعطى له فرصة لتخمين الكلمة السرية الحقيقية لكسب النقاط!',
    },
];
            ...
            <View style={styles.container}>
                ...
                <View style={styles.introContainer}>
                    ...
                    <Text style={styles.introText}>
                        اللعبة التي تختبر ذكاءك في التلميح وقدرتك على الخداع. هل أنت "تعرف الكلمة" أم "ضائع"؟
                    </Text>
                </View>
